...
$(document).ready(function () {
    ...
    tableElement.dataTable({
        ...
        aoColumnDefs   : [
            ...
            {
                aTargets: [ 5 ],
				mDataProp: 'sum',              // Column number which needs to be modified
                sClass  : 'centered-cell',     // Optional - class to be applied to this table cell
				sType: 'numeric'							
            },
			{
            ...
            },
			{
				...
				mDataProp: 'met',
                sClass  : 'categorias'     // Optional - class to be applied to this table cell
            }
        ],
        bProcessing    : true,
        bAutoWidth     : false,
        sAjaxSource    : '../vendedorJSON.php',
