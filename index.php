    ...
    <div class="container-fluid">
          ...
          <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="item active">
                <img src="img/back1.jpg" alt="First slide">
                <div class="container">
                  <div class="carousel-caption">
                    <h1>PLAN LLAVERIA 2014</h1>
                    <p>Llavería es más de lo que usted quería!! </p>
                    
                  </div>
                </div>
              </div>
              <div class="item">
               <img src="img/back2.jpg" alt="First slide">
                <div class="container">
                  <div class="carousel-caption">
              ...
              <div class="item">
               <img src="img/back3.jpg" alt="First slide">
                <div class="container">
                  <div class="carousel-caption">
      ...
      <div class="row sideL">
        <div class="col-md-3 sidebar">
          <div class="loginhome col-md-12">
            <div class="logohome">
              <img src="img/llaverialogo2.png" width="100%">
            </div>
          <?php include("includes/module_login.php"); ?>
          </div>

          <p class="textsmall copy">&copy; Llaveria es un programa de Dow AgroSciences www.dowagro.com/co</p>
