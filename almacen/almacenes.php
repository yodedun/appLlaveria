        ...
        <div class="panel-heading">
         <div class="row">
           <div class="col-md-12 inlineBlock">
              <div class="col-md-9">
                  <h3> <span class="glyphicon glyphicon-list-alt"></span> Ventas <?php echo $_SESSION['MM_Username'] ?></h3>
              </div>
        ...
        <div class="panel-body">
            ...
            <table id="example" cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" >
                ...
                <tr>
                    ...
                    <th data-hide="phone">Falta</th>
                    <th>Bono</th>
                    <th class="hidden-print" data-hide="phone,tablet">Detalle</th>
...
<div class="barras"></div>
        ...
        <script type="text/javascript" src="../js/ajax-almacenesLL.js"></script>
        <script type="text/javascript" src="../js/ajax-almacenesLL2.js"></script>
        <script type="text/javascript" src="../js/ajax-almacenesLL2-2.js"></script>
