...
CONCAT('$ ',FORMAT(metatrimestre.meta, 0)) as meta2,
tblperiodo_llaveria.strDescripcion,

    IF (
      (
         Sum(tblventas_llaveria.intVenta) > metatrimestre.meta
      ),
      (
        IF((Sum(tblventas_llaveria.intVenta) > (metatrimestre.meta  * 115) / 100 ),0,CONCAT('$ ',FORMAT((metatrimestre.meta  * 115) / 100 -  Sum(tblventas_llaveria.intVenta), 0),' para el 115% ')) 
      ),
      CONCAT('$ ',FORMAT(metatrimestre.meta  -  Sum(tblventas_llaveria.intVenta), 0),' para el 100% ')
    ) AS falta1,

CONCAT(FORMAT((( Sum(tblventas_llaveria.intVenta) / metatrimestre.meta)*100 ), 0),' %')as porcentaje,

 IF(

tblperiodo_llaveria.idPeriodo=5

,( IF (( (( Sum(tblventas_llaveria.intVenta) / metatrimestre.meta)*100 ) >= 100 ),
( IF(( (( Sum(tblventas_llaveria.intVenta) / metatrimestre.meta)*100 ) >= 115 ),4,
2) ),
...
,( IF (( (( Sum(tblventas_llaveria.intVenta) / metatrimestre.meta)*100 ) >= 100 ),
( IF(( (( Sum(tblventas_llaveria.intVenta) / metatrimestre.meta)*100 ) >= 115 ),3,
1.5) ),
...
,( IF (( (( Sum(tblventas_llaveria.intVenta) / metatrimestre.meta)*100 ) >= 100 ),
( IF(( (( Sum(tblventas_llaveria.intVenta) / metatrimestre.meta)*100 ) >= 115 ),(Sum(tblventas_llaveria.intVenta)*0.04),
...
,( IF (( (( Sum(tblventas_llaveria.intVenta) / metatrimestre.meta)*100 ) >= 100 ),
( IF(( (( Sum(tblventas_llaveria.intVenta) / metatrimestre.meta)*100 ) >= 115 ),(Sum(tblventas_llaveria.intVenta)*0.03),
...
metatrimestre.intUser=tbluserlista.idUser and
...
metatrimestre.idPeriodo=tblperiodo_llaveria.idPeriodo and
