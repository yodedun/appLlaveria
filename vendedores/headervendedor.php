    ...
    <div class="navbar navbar-default navbar-fixed-top top2">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">Llaveria</a>
        </div>
...
if ((isset($_SESSION['MM_Username'])) && ($_SESSION['MM_Username'] != ""))
   {
     ...
     <div class="navbar-collapse collapse">
            ...
            <li class="active"><a href="vendedores.php">Almacenes</a></li>
          ...
          <div class="form-group">
            ...
            <button type="button" class="btn btn-rojo"  onclick="location.href = '../salir_allusers.php'">
            Salir
            </button>
          </form>
      </div>
