...
if (isset($_GET['almacen'])) {
  $varUser_consultadetalles = $_GET['almacen'];
}
    ...
    <div class="container">
      <!-- Example row of columns -->
        ...
        <div class="panel panel-default">
                <div class="panel-heading"><h3><?php echo $row_consultadetalles['categoria']; ?> en <?php echo $row_consultadetalles['periodo']; ?> <div class="btn btn-success pull-right"><a href="javascript:history.back()">Volver</a></div> <div class="btn btn-success pull-right"><a href="javascript:window.print();">Imprimir</a></div></h3> </div>
