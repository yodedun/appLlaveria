...
tblperiodo_llaveria.strDescripcion,
    ...
    IF((Sum(tblventas_llaveria.intVenta) > (metaPeriodo.meta  * 115) / 100 ),0,CONCAT('$ ',FORMAT((metaPeriodo.meta  * 115) / 100 -  Sum(tblventas_llaveria.intVenta), 0),' para el 115% '))  AS falta1,
...
tblventas_llaveria.intProducto=tblproductos.codProducto
AND tblproductos.intYear = tblperiodo_llaveria.intYear 
AND tblcategorias.idCategoria=8 AND
