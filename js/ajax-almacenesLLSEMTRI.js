...
$(document).ready(function () {
    ...
    tableElement.dataTable({
        ...
        //    },
            {
                aTargets: [ 2 ],
				mDataProp: 'venta',              // Column number which needs to be modified
                sClass  : 'centered-cell',     // Optional - class to be applied to this table cell
				sType: 'numeric'							
            },
			{
        ...
        
			{
                ...
                mRender  : function (data, type) {
                    return '<span><a class="btn btn-success" href="almacenes.php?almacen='+ data + ' ">Detalles</a></span>';
                },
                sClass   : 'centered-cell hidden-print'    // Optional - class to be applied to this table cell
            }
		//	{
        //        aTargets : [ 6 ],             // Column number which needs to be modified
		//		mDataProp: 'intUser',
        ...
        bProcessing    : true,
        bAutoWidth     : false,
        sAjaxSource    : 'almacenesSEMJSONTRI.php?almacen='+ misVariablesGet.almacen +'&date='+ misVariablesGet.date +'',
